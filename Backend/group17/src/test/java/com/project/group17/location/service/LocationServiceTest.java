...
public class LocationServiceTest {
    ...
    public void testAddDefaultLocations() {
        ...
        assertNull(locationRepository.findByCity("Test City 3"));
    }

    @Test
    public void testGetLocationEntity() {
        LocationEntity location = locationService.getLocationEntity("Test City 1");
        assertNotNull(location);
        assertEquals("Test City 1", location.getCity());
